package com.espinosa.burgerorderingform;
...
public class MachineHomework3 extends AppCompatActivity {
    Intent intent;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_machine_homework3);
        intent = new Intent(MachineHomework3.this, MachineHomework3.class);
